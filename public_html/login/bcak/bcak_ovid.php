...
// $refurl2 = 'http://www.bcak.bc.ca/members/elibrary.php';

// valid referring URLs list - new metod - MP MP 12/17/2010
$refurls = array(
 'http://www.bcak.bc.ca/memberonly/memberContentPage.aspx?id=eLibrary',
 'http://bcak.bc.ca/memberonly/memberContentPage.aspx?id=eLibrary',
);

// standard components of all Ovid jumpstart URLs for e-HLbc
$ovid_url_base = 'http://ovidsp.ovid.com/ovidweb.cgi?T=JS';
$ovid_login = '&ID=bcak999&PASSWORD=reliable';
