...
$refurls = array(
 'http://internal.gov.yk.ca/depts/hss/ehlbc/index.html',
 'http://internal.gov.yk.ca/depts/hss/ehlyukon',
 'http://ehlyukon.gov.yk.ca',
);

// standard components of all Ovid jumpstart URLs for e-HLbc
$ovid_url_base = 'http://ovidsp.ovid.com/ovidweb.cgi?T=JS';
$ovid_login = '&ID=yhss999&PASSWORD=healthy';
